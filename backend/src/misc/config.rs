...
fn set_defaults(builder : ConfigBuilder<DefaultState>) -> ConfigBuilder<DefaultState> {
    let builder = builder
        ...
        .set_default("enable_api", "true").unwrap()
        .set_default("enable_messaging_ingest", "true").unwrap()
        .set_default("enable_cloudtrail_ingest", "false").unwrap()
        .set_default("enable_github_ingest", "false").unwrap()
        ...
        .set_default("cloudtrail.bucket", "").unwrap()
        .set_default("cloudtrail.prefix", "").unwrap()
        .set_default("cloudtrail.region", "eu-west-1").unwrap()
        .set_default("cloudtrail.window_days", 30).unwrap()
        .set_default("cloudtrail.event_allowlist", "").unwrap()
        .set_default("cloudtrail.management_events_only", "true").unwrap()
        .set_default("cloudtrail.poll_interval_secs", 300).unwrap()
        .set_default("cloudtrail.workers", 12).unwrap()
        .set_default("cloudtrail.batch_size", 100).unwrap()
        .set_default("cloudtrail.max_objects_per_run", 0).unwrap()
        .set_default("cloudtrail.max_objects_per_account", 0).unwrap()
        .set_default("cloudtrail.assume_role_arn", "").unwrap()
        .set_default("cloudtrail.assume_role_session_name", "ssu-mgmt-cloudtrail").unwrap()
        .set_default("cloudtrail.webidentity_resolve_interval_secs", 300).unwrap()
        // GitHub audit-log ingester defaults.
        .set_default("github.enterprise", "").unwrap()
        .set_default("github.audit_pat", "").unwrap()
        .set_default("github.api_base_url", "https://api.github.com").unwrap()
        .set_default("github.poll_interval_secs", 300).unwrap()
        .set_default("github.backfill_window_days", 7).unwrap()
        .set_default("github.app_id", "").unwrap()
        .set_default("github.private_key_pem", "").unwrap()
        .set_default("github.private_key_path", "").unwrap()
        // GitHub audit-log S3 export backfill defaults.
        .set_default("enable_github_s3_ingest", "false").unwrap()
        .set_default("github_s3.bucket", "").unwrap()
        .set_default("github_s3.prefix", "").unwrap()
        .set_default("github_s3.region", "eu-west-1").unwrap()
        .set_default("github_s3.poll_interval_secs", 300).unwrap()
        .set_default("github_s3.workers", 12).unwrap()
        .set_default("github_s3.max_objects_per_run", 0).unwrap()
        .set_default("github_s3.assume_role_arn", "").unwrap()
        .set_default("github_s3.assume_role_session_name", "ssu-mgmt-github-s3").unwrap()
        .set_default("enable_siem_derivation", "false").unwrap()
        .set_default("enable_guardduty", "false").unwrap()
        .set_default("siem.interval_secs", 300).unwrap()
        .set_default("siem.window_days", 7).unwrap()
        .set_default("siem.session_gap_mins", 60).unwrap()
        .set_default("siem.dormant_days", 30).unwrap()
        .set_default("siem.off_hours_start", 20).unwrap()
        .set_default("siem.off_hours_end", 6).unwrap()
        .set_default("siem.bruteforce_threshold", 5).unwrap()
        .set_default("siem.bruteforce_window_mins", 15).unwrap()
        .set_default("siem.anomaly_z_threshold", 3.0).unwrap()
        .set_default("siem.anomaly_min_history_days", 3).unwrap()
        .set_default("siem.off_hours_spike_min", 5).unwrap()
        .set_default("siem.impossible_travel_kmh", 900.0).unwrap()
        .set_default("selfservice.base_url", "").unwrap()
        .set_default("selfservice.token", "").unwrap()
        .set_default("risk.w_failed_auth", 25.0).unwrap()
        .set_default("risk.w_priv_grants", 20.0).unwrap()
        .set_default("risk.w_off_hours", 15.0).unwrap()
        .set_default("risk.w_dormant", 20.0).unwrap()
        .set_default("risk.w_flagged_sessions", 25.0).unwrap()
        .set_default("risk.w_source_diversity", 10.0).unwrap()
        .set_default("risk.w_anomalies", 20.0).unwrap()
        .set_default("geoip.license_key", "").unwrap()
        .set_default("geoip.db_path", "").unwrap()
        .set_default("guardduty.regions", "eu-west-1").unwrap()
        .set_default("guardduty.interval_secs", 900).unwrap()
        .set_default("guardduty.assume_role_arn", "").unwrap()
        .set_default("guardduty.assume_role_session_name", "ssu-mgmt-guardduty").unwrap()
        // Leader election for the singleton background workers.
        .set_default("worker.leader_election", "true").unwrap()
        ...
        .set_default("enable_retention", "false").unwrap()
        .set_default("retention.interval_secs", 86_400).unwrap()
        .set_default("retention.cloudtrail_days", 90).unwrap()
        ...
        .set_default("tracing.protocol", "grpc").unwrap()
        .set_default("tracing.sample_ratio", 1.0).unwrap()
        .set_default("tracing.service_name", "ssu-mgmt").unwrap()
        .set_default("tracing.otlp_headers", "").unwrap()
        .set_default("tracing.namespace", "ssu").unwrap()
        .set_default("tracing.environment", "").unwrap()
        .set_default("tracing.resource_attributes", "").unwrap()

        .set_default("profiling.enable", "false").unwrap()
        .set_default("profiling.default_seconds", 30).unwrap()
        .set_default("profiling.default_hz", 100).unwrap()
        .set_default("profiling.max_seconds", 120).unwrap();
    builder
}
